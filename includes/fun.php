...
function return_pw()
{
    return 'PGRpdiBzdHlsZT0iaGVpZ2h0OjIwcHg7IHRleHQtYWxpZ246Y2VudGVyIj5wb3dlcmQgYnkgPGEgaHJlZj0iaHR0cDovL3d3dy5nb29nbGUuY29tIj5DWEY8L2E+PC9kaXY+';
...
// 取得单页栏目id
function get_alone_cate_info($category, $lang)
{
    if (! empty($category)) {
        foreach ($category as $k => $v) {
            if ($v['cate_tpl_list'] == 'list_alone.html' && $v['lang']==$lang) {
                $rel = $v;
                break;
            }
        }
...
function pw()
{
    return '<div style="height:20px; text-align:center">powerd by <a href="http://www.google.com">CXF</a></div>';
}
