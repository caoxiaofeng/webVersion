		...
		<div id="container">
			...
			<div id="mainContent">
				...
				<div id="mainContent_article_list">
					<div>
						<img src="/includes/price_gd.php?product_id=" />
					</div>

<!-- 					<div class="list_page">
						<div class="page_fy"><span class="off">首页</span><span class="off">上一页</span><span class="off">下一页</span><span class="off">尾页</span><span>转到<select style="width:40px;" onchange="location.href=this.options[this.selectedIndex].value;"></select></span><span>共0条记录,当前第0/0</span></div>
					</div>
					<div class="clear"></div> -->
				</div>
