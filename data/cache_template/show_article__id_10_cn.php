...
document.write('</object>'); 
  ...
  <div id="category">
    ...
    <div class="mainPageStyle">
      ...
      <div id="position">
        <span>
          当前位置:<a href="/">首页</a> >> <a href="/article/article.php?id=4">氟化盐</a> > 内容列表
        </span>
      </div>
      <div class="clear">
      </div>
        ...
        <div id="mainContent_article_list">
          <div class="box_in">
            ...
            <p class="info">
              <span>
                点击次数:
                <script language="javascript" src="/includes/hits.php?id=10">
                </script>
              </span>
              <span>
            ...
            <div class="page_fy" style="float: none; margin-left: 300px;">
                         ...
                         <!--
              <div class="arc_link" style="clear: both"> <span>上一条:没有了</span><span>下一条:<a href="/article/show_article.php?id=2"  title="头条测试1">头条测试1</a>}</span </div>
            -->
