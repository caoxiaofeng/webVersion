      ...
      <div id="position">
        <p>
          ...
          <span style="vertical-align:middle;">
            您现在的位置:<a href="/">首页</a> >> <a href="/article/article.php?id=4">氟化盐</a> >> 内容列表
          </span>
        </p>
      </div>
      ...
      <div id="mainContent">
        ...
        <div id="mainContent_article_list">
          ...
          <ul class="ul_list_article">
                        <li>
            <b>
              <a href="/article/show_article.php?id=2"  style="">
                头条测试1              </a>
            </b>
            <!-- <span class="time">2014-01-11 15:01:31</span> -->
            <p>
              &nbsp
            </p>
        ...
        <div class="list_page">
          <div class="page_fy">
            <span class="off">首页</span><span class="off">上一页</span><a class="focus" href="?page=1&id=4">1</a><span class="off">下一页</span><span class="off">尾页</span><span>转到<select style="width:40px;" onchange="location.href=this.options[this.selectedIndex].value;"><option value="?page=1&id=4" >1</option></select></span><span>共1条记录,当前第1/1</span>          </div>
        </div>
        <div class="clear">
        </div>
