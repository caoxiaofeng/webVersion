  ...
  <div id="category">
    ...
    <div class="mainPageStyle">
      <div id="container">
        ...
        <!-- 二级分类 -->
          ...
          <div id="subCategory">
            ...
            <a 
                class=""
                href="/article/article.php?id=23"                 title="萤石">
            ...
            <a 
                class=""
                href="/article/article.php?id=24"                 title="氢氟酸">
      ...
      <div id="position">
        <p>
          ...
          <span style="vertical-align:middle;">
            您现在的位置:<a href="/">首页</a> >> <a href="/article/article.php?id=2">原料辅料</a> >> 内容列表
          </span>
        </p>
      </div>
      ...
      <div id="mainContent">
        ...
        <div class="list_page">
          <div class="page_fy">
            <span class="off">首页</span><span class="off">上一页</span><span class="off">下一页</span><span class="off">尾页</span><span>转到<select style="width:40px;" onchange="location.href=this.options[this.selectedIndex].value;"></select></span><span>共0条记录,当前第1/0</span>          </div>
        </div>
        <div class="clear">
        </div>
