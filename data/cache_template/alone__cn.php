...
<link href="/template/default/images/style.css" rel="stylesheet"
	type="text/css">
<link href="/template/default/images/main.css" rel="stylesheet"
	type="text/css">
    ...
    <div class="head_nav">
      <div class="nav_left">
		...
		<div id="container">
			...
			<!-- 当前位置 -->
			<div id="position">
				<span>当前位置:<a href="/">首页</a> >> <a href="/article/article.php?id=1">产品价格</a> > 内容列表</span>
			</div>
			<div class="clear"></div>
			...
			<div id="mainContent">
					...
					<form name="maininfo" method="post" enctype="multipart/form-data"
						action="/alone/alone.php" class="form">
									...
									<tr>
										...
										<td style="width: 20%">
											<select name="product_id">
																																																		<option value=23   selected="selected" >萤石</option>
																										<option value=24  >氢氟酸</option>
				...
				<div id="mainContent_article_list">
					<div>
						<img src="/includes/price_gd.php?product_id=23" />
					</div>

<!-- 					<div class="list_page">
						<div class="page_fy"><span class="off">首页</span><span class="off">上一页</span><span class="off">下一页</span><span class="off">尾页</span><span>转到<select style="width:40px;" onchange="location.href=this.options[this.selectedIndex].value;"></select></span><span>共条记录,当前第1/</span></div>
					</div>
					<div class="clear"></div> -->
				</div>
				...
				<div id="mainContent_r">
					<div id="mainContent_r_grid"><script language='javascript'>
linkarr = new Array();
picarr = new Array();
textarr = new Array();
var swf_width=250;
