...
foreach($fun_return as $nav_child){?>
                          ...
                          <!--
                            <p style="font-size: 9px; white-space: nowrap; color: #c9c9c9; text-align: left; display:
                            block; float: left;"> &nbsp; </p>
                          -->
                          <?php 
}
                          ...
                          <p>
                            ...
                            <p style="float: right; margin-right: 10px; margin-top: 6px;">
                              <a href="<?php echo $nav_child['url'];?>"<?php echo $nav_child['target'];?>>
                                <img src="<?php cmspath('template');?>/images/more_article.gif" alt="banner Img" />
                              </a>
                            </p>
                          </p>
                        </div>
...
foreach($fun_return as $v){?>
                          <p>
                            <img src="<?php cmspath('template');?>/images/article_triangle_tip.png" alt="banner Img" />
                            <a 
                                title="<?php echo $v['title'];?>"
                                href="<?php echo $v['url'];?>"
                                <?php echo                                 $v['target'];?>
                                <?php if(                                $v['style']){?>
                                style="<?php echo $v['style'];?>"<?php }?>>
