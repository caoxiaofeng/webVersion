              ...
              <div id="ajx_area" style="margin-top:4px; height:100px;">
                ...
                <div style="margin-left:50px; margin-top:8px; width:220px; float:center;">
                  ...
                  <a href="<?php cmspath('member');?>/member.php?action=regist&lang=<?php echo get_web_param('lang');?>">
                    <img src="<?php cmspath('template');?>/images/login_index_register.png" style="border:0;float:left;"/>
                  </a>
                  <a href="#">
                    <img src="<?php cmspath('template');?>/images/login_index_forget.png" style="border:0;float:left;" />
                  </a>
                </div>
              </div>
