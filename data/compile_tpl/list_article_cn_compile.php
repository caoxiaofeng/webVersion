...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      <?php echo cateinfo('cate_title_seo');?>_<?php echo webinfo('web_name');?>
    </title>
...
foreach($fun_return as $nav){?>
            ...
            <a 
                ...
                href="<?php echo $nav['url'];?>"<?php echo $nav['target'];?>
      ...
      <div id="position">
        <p>
          <img style="vertical-align:middle;" src="<?php cmspath('template');?>/images/location_tip.png"/>
          <span style="vertical-align:middle;">
            您现在的位置:<?php position(); ?> >> 内容列表
          </span>
        </p>
      </div>
