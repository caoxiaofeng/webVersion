...
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
	id=scriptmain name=scriptmain
	codebase="http://download.macromedia.com/pub/shockwave/cabs/
flash/swflash.cab#version=6,0,29,0"
	width="<?php echo isset($rel_info[0]['flash_width'])?$rel_info[0]['flash_width']:950;?>"
	height="<?php echo isset($rel_info[0]['flash_height'])?$rel_info[0]['flash_height']:200;?>">
	<param name="movie"
		value="<?php echo CMS_SELF;?>data/flash_ad/ad_4/bcastr.swf?bcastr_xml_url=<?php echo $xml_use;?>">
	...
	<embed
		src="<?php echo CMS_SELF;?>data/flash_ad/ad_4/bcastr.swf?bcastr_xml_url=<?php echo $xml_use;?>"
		width="<?php echo isset($rel_info[0]['flash_width'])?$rel_info[0]['flash_width']:950;?>"
		height="<?php echo isset($rel_info[0]['flash_height'])?$rel_info[0]['flash_height']:200;?>"
