<?php
$data[] = array(
    "DROP TABLE IF EXISTS `" . DB_PRE . "admin`;",
    ""
);
$data[] = array(
...
$data[] = array(
    "DROP TABLE IF EXISTS `" . DB_PRE . "admin_group`;",
    ""
);
$data[] = array(
    "CREATE TABLE `" . DB_PRE . "admin_group` (
  `id` mediumint(8) NOT NULL auto_increment,
...
$data[] = array(
    "INSERT INTO `" . DB_PRE . "admin_group` (`id`, `admin_group_name`, `admin_group_info`, `admin_group_purview`, `is_disable`) VALUES
...
$data[] = array(
    "DROP TABLE IF EXISTS `" . DB_PRE . "alone`;",
    ""
);
$data[] = array(
    "CREATE TABLE `" . DB_PRE . "alone` (
...
$data[] = array(
    "DROP TABLE IF EXISTS `" . DB_PRE . "auto_fields`;",
    ""
);
$data[] = array(
    "CREATE TABLE `" . DB_PRE . "auto_fields` (
  `id` mediumint(8) NOT NULL auto_increment,
...
$data[] = array(
    "INSERT INTO `" . DB_PRE . "auto_fields` (`id`, `field_name`, `use_name`, `field_type`, `field_value`, `field_length`, `channel_id`, `field_info`, `is_disable`, `check_value`, `field_order`, `is_del`) VALUES
...
$data[] = array(
    "DROP TABLE IF EXISTS `" . DB_PRE . "block`;",
    ""
);
$data[] = array(
    "CREATE TABLE `" . DB_PRE . "block` (
...
$data[] = array(
    "INSERT INTO `" . DB_PRE . "channel` (`id`, `channel_name`, `channel_mark`, `channel_table`, `is_disable`, `is_member`, `channel_mb_grade`, `is_verify`, `is_del`, `channel_order`, `is_alone`, `list_php`, `content_php`) VALUES
...
$data[] = array(
    "DROP TABLE IF EXISTS `" . DB_PRE . "cmsinfo`;",
    ""
);
$data[] = array(
    "CREATE TABLE `" . DB_PRE . "cmsinfo` (
  `id` mediumint(8) NOT NULL auto_increment,
...
$data[] = array(
    "INSERT INTO `" . DB_PRE . "cmsinfo` (`id`, `info_tag`, `info_array`, `info_name`, `lang_tag`) VALUES
...
$data[] = array(
    "DROP TABLE IF EXISTS `" . DB_PRE . "down`;",
    ""
);
$data[] = array(
    "CREATE TABLE `" . DB_PRE . "down` (
  `id` mediumint(8) NOT NULL,
...
$data[] = array(
    "DROP TABLE IF EXISTS `" . DB_PRE . "form`;",
    ""
);
$data[] = array(
    "CREATE TABLE `" . DB_PRE . "form` (
  `id` mediumint(8) NOT NULL auto_increment,
...
$data[] = array(
    "INSERT INTO `" . DB_PRE . "form` (`id`, `form_name`, `form_mark`, `is_disable`) VALUES
(5, '表单样例1', 'prinfo', 0),
(8, '表单样例12', 'webjob', 0);;",
    "form"
);
...
$data[] = array(
    "DROP TABLE IF EXISTS `" . DB_PRE . "formfield`;",
    ""
);
$data[] = array(
    "CREATE TABLE `" . DB_PRE . "formfield` (
  `id` mediumint(8) NOT NULL auto_increment,
  `field_name` varchar(60) NOT NULL,
...
$data[] = array(
    "INSERT INTO `" . DB_PRE . "formfield` (`id`, `field_name`, `use_name`, `field_type`, `field_value`, `field_length`, `form_id`, `field_info`, `is_disable`, `form_order`, `is_empty`) VALUES
...
$data[] = array(
    "DROP TABLE IF EXISTS `" . DB_PRE . "formlist`;",
    ""
);
$data[] = array(
    "CREATE TABLE `" . DB_PRE . "formlist` (
  `id` mediumint(8) NOT NULL auto_increment,
  `form_id` mediumint(8) default NULL,
...
$data[] = array(
    "DROP TABLE IF EXISTS `" . DB_PRE . "job`;",
    ""
);
$data[] = array(
    "CREATE TABLE `" . DB_PRE . "job` (
  `id` mediumint(8) NOT NULL,
...
$data[] = array(
    "DROP TABLE IF EXISTS `" . DB_PRE . "lang`;",
    ""
);
$data[] = array(
    "CREATE TABLE `" . DB_PRE . "lang` (
  `id` mediumint(8) NOT NULL auto_increment,
...
$data[] = array(
    "INSERT INTO `" . DB_PRE . "lang` (`id`, `lang_name`, `lang_order`, `lang_tag`, `lang_is_use`, `lang_is_open`, `lang_is_url`, `lang_url`, `lang_is_fix`, `lang_main`) VALUES
(9, '简体中文', 10, 'cn', 1, 0, 0, 'http://', 1, 1);",
    ""
);

$data[] = array(
    "DROP TABLE IF EXISTS `" . DB_PRE . "maintb`;",
    ""
);
$data[] = array(
    "CREATE TABLE `" . DB_PRE . "maintb` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
$data[] = array(
    "DROP TABLE IF EXISTS `" . DB_PRE . "member`;",
    ""
);
$data[] = array(
    "CREATE TABLE `" . DB_PRE . "member` (
  `id` mediumint(8) NOT NULL auto_increment,
...
$data[] = array(
    "DROP TABLE IF EXISTS `" . DB_PRE . "member_group`;",
    ""
);
$data[] = array(
    "CREATE TABLE `" . DB_PRE . "member_group` (
  `id` mediumint(8) NOT NULL auto_increment,
...
$data[] = array(
    "INSERT INTO `" . DB_PRE . "member_group` (`id`, `member_group_name`, `member_group_info`, `is_disable`) VALUES
...
$data[] = array(
    "DROP TABLE IF EXISTS `" . DB_PRE . "product`;",
    ""
);
$data[] = array(
    "CREATE TABLE `" . DB_PRE . "product` (
  `id` mediumint(8) NOT NULL,
...
$data[] = array(
    "DROP TABLE IF EXISTS `" . DB_PRE . "ask`;",
    ""
);
$data[] = array(
    "CREATE TABLE `" . DB_PRE . "ask` (
  `id` mediumint(8) NOT NULL auto_increment,
  `title` varchar(200) NOT NULL,
...
$data[] = array(
    "DROP TABLE IF EXISTS `" . DB_PRE . "link`;",
    ""
);
$data[] = array(
    "CREATE TABLE `" . DB_PRE . "link` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
$data[] = array(
    "INSERT INTO `" . DB_PRE . "link` (`id`, `link_url`, `link_name`, `link_logo`, `link_order`, `link_info`, `link_mail`, `lang`, `addtime`, `link_type`) VALUES
(1, '#', '企业网站管理系统', 'http://', 1, '', '', 'cn', '1309053704', 0),
(2, '#', '交流论坛', 'http://', 2, '', '', 'cn', '1309053729', 0),
(3, '#', '在线帮助', 'http://', 3, '', '', 'cn', '1309053749', 0);",
    "link"
);

$data[] = array(
    "DROP TABLE IF EXISTS `" . DB_PRE . "collect`;",
    ""
);
$data[] = array(
    "CREATE TABLE `" . DB_PRE . "collect` (
  `id` mediumint(8) NOT NULL auto_increment,
...
$data[] = array(
    "DROP TABLE IF EXISTS `" . DB_PRE . "prinfo`;",
    ""
);
$data[] = array(
    "CREATE TABLE `" . DB_PRE . "prinfo` (
  `id` mediumint(8) NOT NULL,
...
$data[] = array(
    "DROP TABLE IF EXISTS `" . DB_PRE . "market`;",
    ""
);
$data[] = array(
    "CREATE TABLE `" . DB_PRE . "market` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
$data[] = array(
    "DROP TABLE IF EXISTS `" . DB_PRE . "lang_lang`;",
    ""
);
$data[] = array(
    "CREATE TABLE `" . DB_PRE . "lang_lang` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
  `lang_tag` varchar(60) NOT NULL,
...
$data[] = array(
    "INSERT INTO `" . DB_PRE . "lang_lang` (`id`, `lang_tag`, `lang_value`, `lang`) VALUES
(5, 'pages', '共', 'cn'),
(6, 'pagesize', '条记录', 'cn'),
(7, 'page', '当前第', 'cn'),
(8, 'pagehome', '首页', 'cn'),
...
$data[] = array(
    "DROP TABLE IF EXISTS `" . DB_PRE . "flash_ad`;",
    ""
);
$data[] = array(
    "CREATE TABLE `" . DB_PRE . "flash_ad` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
$data[] = array(
    "DROP TABLE IF EXISTS `" . DB_PRE . "flash_info`;",
    ""
);
$data[] = array(
    "CREATE TABLE `" . DB_PRE . "flash_info` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
$data[] = array(
    "DROP TABLE IF EXISTS `" . DB_PRE . "book`;",
    ""
);
$data[] = array(
    "CREATE TABLE `" . DB_PRE . "book` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
$data[] = array(
    "DROP TABLE IF EXISTS `" . DB_PRE . "book_info`;",
    ""
);
$data[] = array(
    "CREATE TABLE `" . DB_PRE . "book_info` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
$data[] = array(
    "INSERT INTO `" . DB_PRE . "book_info` (`id`, `is_book`, `book_pos`, `book_verify`) VALUES
(1, '1', '2', '0');",
    "book_info_data"
);

$data[] = array(
    "DROP TABLE IF EXISTS `" . DB_PRE . "uppics`;",
    ""
);
$data[] = array(
    "CREATE TABLE `" . DB_PRE . "uppics` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
$data[] = array(
    "DROP TABLE IF EXISTS `" . DB_PRE . "webjob`;",
    ""
);
$data[] = array(
    "CREATE TABLE `" . DB_PRE . "webjob` (
  `id` mediumint(8) NOT NULL,
...
$data[] = array(
    "DROP TABLE IF EXISTS `" . DB_PRE . "upfiles`;",
    ""
);
$data[] = array(
    "CREATE TABLE `" . DB_PRE . "upfiles` (
...
$data[] = array(
    "DROP TABLE IF EXISTS `" . DB_PRE . "uppic_cate`;",
    ""
);
$data[] = array(
    "CREATE TABLE `" . DB_PRE . "uppic_cate` (
`id` MEDIUMINT( 8 ) NOT NULL AUTO_INCREMENT PRIMARY KEY ,
...
$data[] = array(
    "INSERT INTO `" . DB_PRE . "uppic_cate` (`id`, `cate_name`) VALUES
(1, '产品图片'),
(2, '下载图片'),
(3, '其它图片');
",
...
$data[] = array(
    "DROP TABLE IF EXISTS `" . DB_PRE . "flash_ad_cate`;",
    ""
);
$data[] = array(
    "CREATE TABLE `" . DB_PRE . "flash_ad_cate` (
`id` MEDIUMINT( 8 ) NOT NULL AUTO_INCREMENT PRIMARY KEY ,
`cate_name` VARCHAR( 60 ) NOT NULL ,
...
$data[] = array(
    "INSERT INTO `" . DB_PRE . "flash_ad_cate` (`id` ,`cate_name` ,`cate_tpl_id` ,`is_disable`)VALUES (NULL , '默认', '0', '1');",
    ""
);

$data[] = array(
    "DROP TABLE IF EXISTS `" . DB_PRE . "mx_form`;",
    ""
);
$data[] = array(
    "CREATE TABLE `" . DB_PRE . "mx_form` (
  `id` mediumint(8) NOT NULL,
