...
elseif ($action == 'save_add') {
    ...
    if (empty($lang)) {
        msg("<span style=\"color:red\">【语言】参数发生错误</span>");
    }
    if (empty($link_url)) {
        msg("<span style=\"color:red\">【网站网址】不能为空</span>");
    }
    if (empty($link_name)) {
    ...
    if (strlen($link_info) > 200) {
        msg('<span style=\"color:red\">网站说明太长，请缩短</span>');
    }
