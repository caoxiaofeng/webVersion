<?php
/*
 * ======================================================================= // File: JPGRAPH_MESHINTERPOLATE.INC.PHP // Description: Utility class to do mesh linear interpolation of a matrix // Created: 2009-03-09 // Ver: $Id: jpgraph_meshinterpolate.inc.php 1709 2009-07-30 08:00:08Z ljp $ // // Copyright (c) Asial Corporation. All rights reserved. //========================================================================
 */
...
class MeshInterpolate
{
     ...
     * corner at $row,$col.
     * The $aFactordecides how many spliots should be done.
     * i.e. how many more divisions should be done recursively
     *
     * @param $row Top
     *            left corner of square to work with
     * @param $col Top
     *            left corner of square to work with
     ...
     * in vert and horizontal axis are $aIntNbr more.
     * For example $aIntNbr=2 will
     ...
     *
     * @param $ &$aData
     *            The original data matricde
     * @param $aInNbr Interpolation
     *            factor
