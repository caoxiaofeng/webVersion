...
class DigitalLED74
{
 ...
 = array(
        ...
        LEDC_LIMEGREEN => array(
            'limegreen:0.9',
            'limegreen:0.5',
            'limegreen:0.4'
        ),
        LEDC_FORESTGREEN => array(
            'forestgreen',
            'forestgreen:0.7',
            'forestgreen:0.5'
        ),
        ...
        */
        ...
        '|' => array(
            ...
            4,
            4
        ), //vertical line, used for simulate rus 'Ы'
            ','// vertical line, used for simulate rus 'Ы'
        null => array(
            0,
            0,
        ...
        null => array(
            ...
            0,
            0
        ), //159 show small hi-stick - that need for simulate rus 'Ф'
            "\t"// 159 show small hi-stick - that need for simulate rus 'Ф'
        null => array(
            8,
            8,
            ...
            0,
            0
        ), //show hi-stick - that need for simulate rus 'У'
            "\r"// show hi-stick - that need for simulate rus 'У'
        null => array(
            8,
            8,
            8,
            ...
            8,
            8
        ), //vertical line - that need for simulate 'M', 'W' and rus 'М','Ш' ,'Щ'
            "\n"// vertical line - that need for simulate 'M', 'W' and rus 'М','Ш' ,'Щ'
        null => array(
            15,
            15,
            ...
            15,
            15
        ), //fill up - that need for simulate rus 'Ж'
            "Ґ"// fill up - that need for simulate rus 'Ж'
        null => array(
            10,
            5,
            10,
...
function _GetLED($aLedIdx, $aColor = 0)
{
    ...
    $height = $this->iLED_Y * $this->iRad * 2 + ($this->iLED_Y) * $this->iMarg + $this->iRad * 2;
        ...
        $rad// Adjust radious for supersampling
        null = 
    
    $this->iRad * $this->iSuperSampling;
        
        // Margin in between "Led" dots
        $marg// Margin in between "Led" dots
        null = 
    
    $this->iMarg * $this->iSuperSampling;
