...
/*
 * =================================================== // CLASS RGB // Description: Color definitions as RGB triples //===================================================
 */
class RGB
{
        ...
        if (is_array($aColor)) {
            if (count($aColor) == 3) {
                if (is_numeric($aColor[0]) && is_numeric($aColor[1]) && is_numeric($aColor[2])) {
                    if (($aColor[0] >= 0 && $aColor[0] <= 255) && ($aColor[1] >= 0 && $aColor[1] <= 255) && ($aColor[2] >= 0 && $aColor[2] <= 255)) {
    ...
    static function GetSpectrum($aVal, $aDynamicRange = 1.0)
    {
        if ($aVal < 0 || $aVal > 1.0001) {
            return array(
                ...
                0,
                0
            ); // Invalid case - just return black
        }
        ...
        if ($aVal <= 0.25) {
            ...
            return array(
                0,
                $sat,
                round($sat - $sat * ($aVal - 0.25) / $a)
            );
        } elseif ($aVal <= 0.75) {
            return array(
                round($sat * ($aVal - 0.5) / $a),
                $sat,
                0
            );
        } else {
