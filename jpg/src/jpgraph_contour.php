<?php
/*
 * ======================================================================= // File: JPGRAPH_CONTOUR.PHP // Description: Contour plot // Created: 2009-03-08 // Ver: $Id: jpgraph_contour.php 1870 2009-09-29 04:24:18Z ljp $ // // Copyright (c) Asial Corporation. All rights reserved. //========================================================================
 */
...
/**
 * This class encapsulates the core contour plot algorithm.
...
class Contour
{
     ...
     *
     * @param $aMatrix The
     *            values to find the contour from
     * @param $aIsobars Mixed.
     *            If integer it determines the number of isobars to be used. The levels are determined
    ...
    /**
     * Flip the plot around the Y-coordinate.
     * This has the same affect as flipping the input
     * data matrice
     *
     * @param $aFlg If
     *            true the the vertice in input data matrice position (0,0) corresponds to the top left
     ...
     *
     * @param $aRow Row
     *            index of edge to be checked
     * @param $aCol Col
     *            index of edge to be checked
     * @param $aIsobar Isobar
     *            value
    ...
    /**
     * Determine all edges, horizontal and vertical that the specified isobar crosses.
     * The crossings
     * are recorded in the two edge matrices.
     *
     * @param $aIsobar The
     *            value of the isobar to be checked
     */
     ...
     * @param $aCol Column
     *            of edge
     * @param $aEdgeDir Determine
     *            if this is a horizontal or vertical edge
     * @param $ib The
     *            isobar value
     * @return unknown_type
     */
     ...
     * For each isobar the crossing of the edges are determined
...
class ContourPlot extends Plot
{
    ...
    /**
     * Construct a contour plotting algorithm.
     * The end result of the algorithm is a sequence of
     * line segments for each isobar given as two vertices.
     *
     * @param $aDataMatrix The
     *            Z-data to be used
     * @param $aIsobar A
     *            mixed variable, if it is an integer then this specified the number of isobars to use.
     ...
     * @param $aInvert By
     *            default the matrice with row index 0 corresponds to Y-value 0, i.e. in the bottom of
     ...
     * @param $aHighContrast Use
     *            high contrast colors (blue/red:ish)
     * @param $aHighContrastBW Use
     *            only black colors for contours
     ...
     *
     * @param $aFlg true
     *            if the legend should start with the lowest isobar on top
     * @return unknown_type
     */
    ...
    {
        return array(
            count($this->dataMatrix[0]) - 1,
            count($this->dataMatrix) - 1
        );
    }
     ...
     *
     * @param $aFlg True,
     *            to use high contrast color
     * @param $aBW True,
     *            Use only black and white color schema
     */
    function UseHighContrastColor($aFlg = true, $aBW = false)
    {
        $this->highcontrast = $aFlg;
    ...
    /**
     * Internal method.
     * Stroke the contour plot to the graph
     *
     * @param $img Image
     *            handler
     * @param $xscale Instance
     *            of the xscale to use
     * @param $yscale Instance
     *            of the yscale to use
     */
