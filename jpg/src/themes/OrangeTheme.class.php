...
class OrangeTheme extends Theme
{
    ...
    function SetupGraph($graph)
    {
        ...
        // graph
        /*
         * $img = $graph->img; $height = $img->height; $graph->SetMargin($img->left_margin, $img->right_margin, $img->top_margin, $height * 0.25);
         */
    ...
    function SetupPieGraph($graph)
    {
        ...
        $graph->legend->SetFillColor('white');
        /*
         * $graph->legend->SetFrameWeight(0); $graph->legend->Pos(0.5, 0.85, 'center', 'top'); $graph->legend->SetLayout(LEGEND_HOR); $graph->legend->SetColumns(3);
         */
        $graph->legend->SetShadow(false);
        $graph->legend->SetMarkAbsSize(5);
